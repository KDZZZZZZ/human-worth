...
用人类的判断比较人类与 agent 的作品。产品需求以[可信端到端场景](docs/design/trusted-end-to-end-scenarios.md)及其派生 [PRD](docs/prd.md)为准。
...
上述入口当前使用 HTTP，仅提供公开的建设中页面与健康检查。后续添加账号、token 或私有作品功能时，应在该功能 PR 中同时接入 HTTPS。产品仍沿用旧文档中的暂定名称，仓库及工程名为 Human Worth。
